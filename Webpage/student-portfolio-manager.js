...
class StudentPortfolioManager {
  ...
  loadStudentData() {
    this.studentDirectories = [
      ...
      {
        folderName: "Sudhanshu_bhakare",
        name: "Sudhanshu R Sakhare",
        course: "MCA",
        batch: 1,
        status: "active",
        resumeFile: "Sudhanshu_Sakhare.html",
        profileImage: "sudhanshu.jpg",
        uploadDate: "2025-01-15",
        specialization: "Full Stack MERN Development",
      },
      ...
      // Batch 2 Students
      {
        folderName: "Student_Name_3_BTECH",
        name: "Student Name 3",
        course: "B.Tech CSE",
        batch: 2,
        status: "pending",
      ...
      {
        folderName: "Student_Name_4_BTECH",
        name: "Student Name 4",
        course: "B.Tech CSE",
        batch: 2,
        status: "pending",

...
class StudentPortfolioManager {
  ...
  loadStudentData() {
    this.studentDirectories = [
      // ACTIVE STUDENTS (Folders uploaded)
      {
        ...
        profileImage: "Images/sudhanshuPic.jpg",
      ...
      },
      {
        ...
        profileImage: "Images/Mansi_Nandanwar.jpg",
      ...
      },
      {
        ...
        profileImage: "Images/Pranay_Bhagat.jpg",
      ...
      
      {
        ...
        profileImage: "Images/GargeePurwar.jpg",
        uploadDate: "2025-07-20",
        specialization: "Java Full Stack Development",
      },
        {
        ...
        profileImage: "Images/Fulanshu_Kuthe.jpg",
        uploadDate: "2025-07-20",
        specialization: "Java Full Stack Development",
      },
      {
        ...
        profileImage: "Images/utkarsha.jpg",
      ...
      },
       {
        ...
        batch: 1,
        status: "active",
        resumeFile: "sarikakhorgade.html",
        profileImage: "Images/Sarika_Khorgade.jpg",
        uploadDate: "2025-07-20",
        specialization: "Java Full Stack Development",
      },
...

      {
        ...
        batch: 1,
        status: "active",
        resumeFile: "Rupali.html",
        profileImage: "Images/Rupali-profile.jpg",
        uploadDate: "2025-07-20",
        specialization: "Java Full Stack Development",
      },
      {
        ...
        batch: 1,
        status: "active",
        resumeFile: "Pratiksha_R.html",
        profileImage: "Images/Pratiksha.jpeg",
        uploadDate: "2025-07-20",
        specialization: "Java Full Stack Development",
      },
     
      {
        ...
        batch: 1,
        status: "active",
        resumeFile: "Vaidehi_Warambhe.html",
        profileImage: "Images/Vaidehi_Warambhe.jpeg",
      ...
      },
      {
        ...
        profileImage: "Images/Ishika.jpg",
        uploadDate: "2025-07-21",
        specialization: "Java Full Stack Development",
      },
      {
        ...
        batch: 1,
        status: "active",
        resumeFile: "vaide_Bhilawe.html",
        profileImage: "Images/Vaidehi.jpg",
        uploadDate: "2025-07-21",
        specialization: "Java Full Stack Development",
      },
      {
        ...
        profileImage: "Images/aachal-profile.jpg",
        uploadDate: "2025-07-21",
        specialization: "Java Full Stack Development",
      },
       {
        ...
        batch: 1,
        status: "active",
        resumeFile: "Varsha_Resume.html",
        profileImage: "Images/Varsha_Mohod.jpeg",
        uploadDate: "2025-07-21",
        specialization: "Java Full Stack Development",
      },
      {
        ...
        profileImage: "Images/sarang.jpg",
        uploadDate: "2025-07-21",
        specialization: "Java Full Stack Development",
      },
     
       {
        ...
        batch: 1,
        status: "active",
        resumeFile: "Shantanu.html",
        profileImage: "Images/Shantanu.png",
        uploadDate: "2025-07-22",
        specialization: "Java Full Stack Development",
      },
      {
        ...
        batch: 1,
        status: "active",
        resumeFile: "NirajG.html",
        profileImage: "Images/nirajgore.jpeg",
        uploadDate: "2025-07-22",
        specialization: "Java Full Stack Development",
      },
      {
        ...
        batch: 1,
        status: "active",
        resumeFile: "Purwa_ughade.html",
        profileImage: "Images/Purwa_ughade.jpeg",
        uploadDate: "2025-07-22",
        specialization: "Java Full Stack Development",
      },
      {
        ...
        profileImage: "Images/prashika.jpg",
        uploadDate: "2025-07-22",
        specialization: "Java Full Stack Development",
      },
      {
        ...
        profileImage: "Images/GHOMVS.jpg",
        uploadDate: "2025-07-22",
        specialization: "Java Full Stack Development",
      },
      
      {
        ...
        batch: 1,
        status: "active",
        resumeFile: "Gayatri_J.html",
        profileImage: "Images/Gayatri_Jaiswal.jpg",
        uploadDate: "2025-07-22",
        specialization: "Java Full Stack Development",
      },
  ...
  filterStudents(students) {
    return students.filter((student) => {
      ...
      if (
        ...
        !student.course.toLowerCase().includes("b.tech")
      )
        matchesFilter = false;
  ...
  renderStudents() {
    ...
    this.updateStatistics(batch1Students);
    this.updateBatchTitles(batch1Students);
  ...
  updateStatistics(batch1Students, batch2Students) {
    ...
    const totalStudents = batch1Students.length;
